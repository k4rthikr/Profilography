...
<body id="home" data-spy="scroll" data-target="#primary-nav">
  <div class="navbar navbar-inverse navbar-fixed-top">
    <div class="navbar-inner">
      <div class="container">
        ...
        <a class="brand" href="http://www.karthikrajan.in">Karthik Rajan</a>
        <div id="primary-nav" class="nav-collapse">
          <ul class="nav">
            ...
            <li class=""><a class="anchorLink" href="#research">Research</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="span12 headline">
          ...
          <i class="description">Amazon, Hyderabad</i>
        </div><!--/span12-->
      </div><!--/row-->
            ...
            <div class="carousel-inner">
              ...
              <div class="active item">
                <div class="row">
                  ...
                  <div class="span4">
                    <h2>Software Development Engineer, Customer Service Technologies</h2>
              ...
              <div class="item">
                <div class="row">
                  <div class="span6 animated rotateInDownLeft">
                    <img src="./files/security_certifier_3.jpg" alt="Security Certifier, Amazon">
                  </div>
                  <div class="span4 animated rotateInUpRight">
                    <h2>Security Certifier, Amazon</h2>
              ...
              <div class="item">
                <div class="row">
                  ...
                  <div class="span4 animated fadeInDownBig">
                    <h2>SDE Intern, Ad Quality, Yahoo! India Ltd</h2>
  ...
  <div class="container">
    ...
    <section id="services">
      ...
      <div class="row">
        ...
        <div class="span3">
          <div class="well">
            <strong>Item Details</strong>
            <hr>
            <p><i class="icon-tag"></i> That’s perfect for spontaneous movie nights (or afternoons or mornings). <a href="#" rel="tooltip" data-original-title="fancy tooltip">Search by top movie</a> title, or genre. Can’t decide? Read reviews, watch trailers, and check out Rotten Tomatoes ratings.</p>
          </div>
        </div>
      </div>
      <br>
      <div class="row">
        <div class="span4">
          <img class="framed" src="./files/product-3.png" alt="">
          <br>
        </div>
        <div class="span5">
      ...
      <div class="row">
        <div class="span4">
          <img class="framed" src="./files/product-4.png" alt="">
          <br>
        </div>
        <div class="span5">
          <h4>Fourth Product Overview</h4>
          <p>Make any time prime time. Buy your favorite TV shows and watch them — without commercials — whenever you like. Watch a show the day after it airs, or camp out on your couch and catch.</p>
          <p>Like you, we love building awesome products on the web. We love it so much, we decided to help people just like us do it easier, better, and faster. <a href="#" rel="tooltip" data-original-title="fancy tooltip">Bootstrap</a> is built for you.</p>
        </div>
        <div class="span3">
          <div class="well">
            <strong>Item Details</strong>
      ...
      <div class="row">
        <div class="span12">
          <ul class="thumbnails">
            ...
            <li class="span3">
              <div class="thumbnail">
                <a class="js-fancybox" rel="album" href="assets/portfolio-large-1.png" title="Portfolio Item #5"><img src="./files/portfolio-thumbnail-1.png" alt=""></a>
                <div class="caption">
                  <h4>Image Title</h4>
                  <hr>
                  <p>Short description for this Portfolio item.</p>
            ...
            <li class="span3">
              <div class="thumbnail">
                <a class="js-fancybox" rel="album" href="assets/portfolio-large-1.png" title="Portfolio Item #6"><img src="./files/portfolio-thumbnail-1.png" alt=""></a>
                <div class="caption">
                  <h4>Image Title</h4>
                  <hr>
                  <p>Short description for this Portfolio item.</p>
            ...
            <li class="span3">
              <div class="thumbnail">
                <a class="js-fancybox" rel="album" href="assets/portfolio-large-1.png" title="Portfolio Item #7"><img src="./files/portfolio-thumbnail-1.png" alt=""></a>
                <div class="caption">
                  <h4>Image Title</h4>
                  <hr>
                  <p>Short description for this Portfolio item.</p>
            ...
            <li class="span3">
              <div class="thumbnail">
                <a class="js-fancybox" rel="album" href="assets/portfolio-large-1.png" title="Portfolio Item #8"><img src="./files/portfolio-thumbnail-1.png" alt=""></a>
                <div class="caption">
                  <h4>Image Title</h4>
                  <hr>
                  <p>Short description for this Portfolio item.</p>
    ...
    <section id="contact">
      ...
      <div class="row container">
        <div class="span12">
        <p>I'll update this part with a Contact form soon. But until then, feel free to ping me directly at: <h3>k4rthikr@gmail.com</h3></p>
      </div>
  ...
  <script src="./files/jquery.anchor.js" type="text/javascript"></script>
